const  ZBOT = 'AMPIBI'; // Nama Bot Whatsapp
const instagram = 'https://instagram.com/Muha.Frmn'; // Nama Instagramlu cok
const nomer = 'https://Wa.me/+62887433082564'; // Nomor whatsapplu cok
const aktif = 'Tergantung kuota'; // Kapan bot lu aktif
const groupwa = 'comming soon'; // OFFICIAL GRUP LU 1
const youtube = 'GADA YOUTUBE'; 
...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=62887433082564:+62 887-4330-82564\n' // WhatsApp ID + phone number
            + 'END:VCARD'
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] ZBOT Ready scan now!`);
});
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @Muha.Frmn`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @Muha.Frmn`)
})
...
conn.sendMessage(id, 'Owner ZBOT wa.me/+62887433082564' ,MessageType.text);
}
else if (text == 'affis'){
conn.sendMessage(id, 'Aku BOT nya ZBOT' ,MessageType.text);
}
else if (text == 'audio'){
...
conn.sendMessage(id, menu.menu(id,  ZBOT, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwa, youtube) ,MessageType.text);
}
if (text == '#donasi'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, donate.donate(id,  ZBOT, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwa, youtube) ,MessageType.text);
}
else if (text == '#donate'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, donate.donate(id,  ZBOT, corohelp, tampilTanggal, tampilWaktu, nomer, aktif, groupwa, youtube) ,MessageType.text);
}
else if (text == '#DONATE'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, info.info(id,  ZBOT, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwa, youtube) ,MessageType.text);
}
else if (text == '#foto'){
conn.sendMessage(id, 'kirim .foto cewek/cowok\n\nContoh: .foto cewek' ,MessageType.text);
}
else if (text == '#menu'){
conn.sendMessage(id, ' 🔍Thanks Telah Menggunakan BOT *ZBOT* , Follow Instagram Mimin Yah🔍� : https://instagram.com/Muha.Frmn' ,MessageType.text);
}
else if (text == '#info'){
conn.sendMessage(id, ' 🔍Thanks Telah Menggunakan BOT *ZBOT* , Follow Instagram Mimin Yah🔍� : https://instagram.com/Muha.Frmn' ,MessageType.text);
}
